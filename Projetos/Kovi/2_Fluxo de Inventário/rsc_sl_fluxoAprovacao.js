...
define(['N/record', 'N/ui/serverWidget', 'N/search', 'N/url', 'N/runtime', 'N/error'], function(record, ui, search, url, runtime, error) {
    ...
    function onRequest(ctx) {
        ...
        var paramForm = criaForm()
        preencheLista(paramFunc, paramForm.link, paramForm.sublist)
        
        
        function confereFuncionario() {
            var usuario = runtime.getCurrentUser();
            var email = usuario.email
            var localidadeUser;
            log.debug('usuário', usuario)
            /**
             * trocar o método de validação para o ID do funcionário.
             */
        ...
        function criaForm() {
            ...
            return {link: link, sublist: sublist}
        }

        function preencheLista(localidadeUser, link, sublist){
            var lista = []
